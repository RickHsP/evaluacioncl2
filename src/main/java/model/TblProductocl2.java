...
public class TblProductocl2 implements Serializable {
	...
	private String preciocompcl2;

	private String precioventacl2;
	...
	public String getPreciocompcl2() {
		return this.preciocompcl2;
	}

	public void setPreciocompcl2(String preciocompcl2) {
		this.preciocompcl2 = preciocompcl2;
	}

	public String getPrecioventacl2() {
		return this.precioventacl2;
	}

	public void setPrecioventacl2(String precioventacl2) {
