...
public class TblProductocl3 implements Serializable {
	...
	private String preciocompcl3;

	private String precioventacl3;
	...
	public String getPreciocompcl3() {
		return this.preciocompcl3;
	}

	public void setPreciocompcl3(String preciocompcl3) {
		this.preciocompcl3 = preciocompcl3;
	}

	public String getPrecioventacl3() {
		return this.precioventacl3;
	}

	public void setPrecioventacl3(String precioventacl3) {
